    ...
    <form class="form-horizontal" name="modifyForm" role="form" method="post" action="/project/member/modify.do">
    	<br><br>
          ...
          <div class="form-group" id="divEmail">
              ...
              <div class="col-lg-10">
                  <input type="email" class="form-control" id="email" name="email" value="${memberDTO.email }" placeholder="ex)abc@gmail.com" maxlength="40" required>
		...
		<label for="inputEmail" class="col-lg-2 control-label">생년월일</label>
          ...
          <div class="form-group">
              <div class="col-lg-offset-2 col-lg-10">
                  ...
                  <button type="button" class="btn btn-secondary" onclick="location.href='/project/member/memberInfo.do'">취소</button> 
              </div>
          </div>
	</form>
</div>
