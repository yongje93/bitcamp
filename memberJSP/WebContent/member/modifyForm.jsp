...
<form name="modifyForm" method="post" action="modify.jsp">
      ...
      <table border="1" cellspacing="0" cellpadding="5">
        ...
        <tr>
          <th width="80">주소</th>
          <td>
            <input type="text" name="zipcode" id="daum_zipcode" value="<%=memberDTO.getZipcode() %>" style="width: 70px;" readonly>
            <input type="button" value="우편번호검색" onclick="checkPost()"><br>
            <input type="text" name="addr1" id="daum_addr1" placeholder="주소" value="<%=memberDTO.getAddr1() %>" style="width: 350px;" readonly><br>
            <input type="text" name="addr2" id="daum_addr2" placeholder="상세 주소" value="<%=memberDTO.getAddr2() %>" style="width: 350px;">
          </td>
        </tr>
        <tr>
