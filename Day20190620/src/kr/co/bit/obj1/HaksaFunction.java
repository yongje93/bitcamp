...
public class HaksaFunction {
	public void register(Scanner input, ArrayList<HashMap<String, String>> haksaList, int protocol) { // 등록
		if (protocol == 1) {
...
//			}
	...
	public void list(Scanner input, ArrayList<HashMap<String, String>> haksaList) {
